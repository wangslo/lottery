    ...
    <div class="wrap">
      <div class="trend" id="trendBox">
        <table class="chartTable" id="chartBody">
          <thead>
            <tr>
              <th id="imgSort" rowspan="2"><strong>期号</strong></th>
              <th rowspan="2" class="bd"></th>
              <th colspan="10" width="179">第一位</th>
              <th class="bd" rowspan="2"></th>
              <th colspan="10" width="179">第二位</th>
              <th class="bd" rowspan="2"></th>
              <th colspan="10" width="179">第三位</th>
              <th class="bd" rowspan="2"></th>
              <th colspan="10" width="179">第四位</th>
              <th class="bd" rowspan="2"></th>
              <th colspan="10" width="179">第五位</th>
            </tr>
            <tr>
              <th>0</th>
              <th>1</th>
  ...
  export default {
    ...
    methods:{
      async getplwData(){
        var _this = this
        this.LOADING = true
        await orgModuleApi.getplwData().then(res => {
          if (res.code == "0") {
